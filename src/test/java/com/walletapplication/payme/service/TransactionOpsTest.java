...
class TransactionOpsTest {
    ...
    void testSendMoney() {
        ...
        TransactionResponse actualSendMoneyResult = transactionOps
                .sendMoney(new TransactionRequest(TRANSACTIONTYPE.CREDIT, "42", "42", 10.0d));
        ...
        assertEquals("Amount transferred from wallet 42", actualSendMoneyResult.getDescription());
    ...
    void testSendMoney2() {
        ...
        cashback.setTransactionTime(LocalDate.of(1970, 1, 1).atStartOfDay());
        when(cashbackRepo.save(Mockito.<Cashback>any())).thenReturn(cashback);
        when(transactionRepo.save(Mockito.<Transaction>any())).thenThrow(new GlobalWalletException("An error occurred"));
    ...
    void testSendMoney5() {
        ...
        // Act and Assert
        assertThrows(GlobalWalletException.class,
                () -> transactionOps.sendMoney(new TransactionRequest(TRANSACTIONTYPE.CREDIT, "42", "42", 0.0d)));
        verify(accountRepo, atLeast(1)).findById(Mockito.<String>any());
    }
    ...
    void testAddMoney() {
        ...
        verify(cashbackRepo).save(Mockito.<Cashback>any());
        verify(transactionRepo).save(Mockito.<Transaction>any());
        assertEquals("Money added to wallet", actualAddMoneyResult.getDescription());
    ...
    void testGetTransactions2() {
        ...
        when(transactionRepo.findByAssociatedAccount(Mockito.<String>any()))
                .thenThrow(new GlobalWalletException("An error occurred"));

        // Act and Assert
        assertThrows(GlobalWalletException.class, () -> transactionOps.getTransactions("3"));
        verify(transactionRepo).findByAssociatedAccount(Mockito.<String>any());
    }
    ...
    void testGetCashbacks2() {
        ...
        // Act and Assert
        assertThrows(GlobalWalletException.class, () -> transactionOps.getCashbacks("3"));
        verify(cashbackRepo).findByAccountNumber(Mockito.<String>any());
    }
    ...
    void testCalculateCashback() {
        ...
        assertEquals(0.3d, transactionOps.calculateCashback(10.0d));
    }
